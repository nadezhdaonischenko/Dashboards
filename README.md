...
*   [🚴 **Метрики сервиса доставки еды**](https://datalens.yandex/54tz3jlk34aar) — Анализ пользовательского поведения (DAU), Retention и продуктовые метрики.
*   [🛡️ **Работа страховой компании**](https://datalens.yandex/es79r0k9ksa00) — Портрет клиента.
